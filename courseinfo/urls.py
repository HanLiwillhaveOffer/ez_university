"""li_han_ez_university URL Configuration
...
from courseinfo.views import (
    ...
    SemesterCreate,
    StudentCreate,
    CourseCreate, RegistrationCreate, InstructorUpdate, SectionUpdate, StudentUpdate, SemesterUpdate, CourseUpdate,
    RegistrationUpdate, InstructorDelete,SectionDelete,CourseDelete,SemesterDelete,StudentDelete,RegistrationDelete)
